const o=t=>{if(!t)return;const e=window.open("","_blank");if(!e){alert("Please allow popups to print the invoice");return}const a="SPD",n=`
        <html>
        <head>
    ...
    `;e.document.write(n),e.document.close()},l=t=>{if(!t)return;const e=window.open("","_blank");if(!e){alert("Please allow popups to print");return}const a="SPD",n=`
        <html>
        <head>
