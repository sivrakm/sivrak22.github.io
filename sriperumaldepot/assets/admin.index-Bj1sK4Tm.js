import{j as t,a as J,r as h,C as K,b as L,d as D,q as A,o as M,w as N,g as R,e as Y,f as _}from"./index-CA5h76Mg.js";import{c as f,B as s,T as n,a as u}from"./Button-C82hmiKU.js";import{H as X}from"./Header-BJU5Tyq9.js";import{A as $}from"./Avatar-d0z9RSuQ.js";import{P as Z}from"./Page-KnwPHrkn.js";import{G as d}from"./Grid-DOv-weqJ.js";import{S as z}from"./ShoppingCart-C7DrNxOQ.js";import{S as T}from"./Stack-BfHIBaWj.js";import{C as k}from"./Card-_cQOhzWD.js";import{I as tt}from"./IconButton-C9bQE-uE.js";import{E as et}from"./ExpandMore-DUcxV7cN.js";import{C as ot}from"./Collapse-DI0bXZpx.js";import{C as E}from"./CardContent-Cd5EgCoF.js";import{C as st}from"./CheckCircle-fAEqnSjH.js";import{C as rt,I as nt,H as it}from"./Inventory2-DQ4yva9-.js";import{L as at}from"./LocalShipping-DUl9-OaP.js";import"./useThemeProps-CgAddm1V.js";const lt=f([t.jsx("path",{d:"M17 11c.34 0 .67.04 1 .09V6.27L10.5 3 3 6.27v4.91c0 4.54 3.2 8.79 7.5 9.82.55-.13 1.08-.32 1.6-.55-.69-.98-1.1-2.17-1.1-3.45 0-3.31 2.69-6 6-6"},"0"),t.jsx("path",{d:"M17 13c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4m0 1.38c.62 0 1.12.51 1.12 1.12s-.51 1.12-1.12 1.12-1.12-.51-1.12-1.12.5-1.12 1.12-1.12m0 5.37c-.93 0-1.74-.46-2.24-1.17.05-.72 1.51-1.08 2.24-1.08s2.19.36 2.24 1.08c-.5.71-1.31 1.17-2.24 1.17"},"1")]),dt=f([t.jsx("path",{d:"m12 2-5.5 9h11z"},"0"),t.jsx("circle",{cx:"17.5",cy:"17.5",r:"4.5"},"1"),t.jsx("path",{d:"M3 13.5h8v8H3z"},"2")]),ct=f(t.jsx("path",{d:"M20 2H4c-1 0-2 .9-2 2v3.01c0 .72.43 1.34 1 1.69V20c0 1.1 1.1 2 2 2h14c.9 0 2-.9 2-2V8.7c.57-.35 1-.97 1-1.69V4c0-1.1-1-2-2-2m-5 12H9v-2h6zm5-7H4V4l16-.02z"})),pt=f(t.jsx("path",{d:"M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m1.41 16.09V20h-2.67v-1.93c-1.71-.36-3.16-1.46-3.27-3.4h1.96c.1 1.05.82 1.87 2.65 1.87 1.96 0 2.4-.98 2.4-1.59 0-.83-.44-1.61-2.67-2.14-2.48-.6-4.18-1.62-4.18-3.67 0-1.72 1.39-2.84 3.11-3.21V4h2.67v1.95c1.86.45 2.79 1.86 2.85 3.39H14.3c-.05-1.11-.64-1.87-2.22-1.87-1.5 0-2.4.68-2.4 1.64 0 .84.65 1.39 2.67 1.91s4.18 1.39 4.18 3.91c-.01 1.83-1.38 2.83-3.12 3.16"})),xt=f(t.jsx("path",{d:"m16 6 2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z"}));function Pt(){const a=J(),[c,p]=h.useState([]),[m,v]=h.useState(!0),[F,P]=h.useState(0),[H,I]=h.useState(0),[C,O]=h.useState(null),S=(e,o)=>{try{const r=Y(D,"orders",e);_(r,{status:o}),(async()=>{try{const i=L(D,"orders"),g=A(i,M("timestamp","desc"),N("status","==","pending")),b=(await R(g)).docs.map(j=>({id:j.id,...j.data()}));p(b);const x=b.length,w=b.reduce((j,Q)=>j+(Number(Q.total)||0),0);I(x),P(Number(w.toFixed(2)))}catch(i){console.error("Error refreshing data:",i)}})()}catch(r){console.error("Error updating order status:",r),alert("Failed to update order status")}},V=e=>{if(!e)return"Just now";const o=e.toDate(),l=new Date().getTime()-o.getTime(),i=Math.floor(l/(1e3*60*60*24));return i===0?`Today, ${o.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}`:i===1?`Yesterday, ${o.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}`:o.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})},U=e=>{O(C===e?null:e)},B=e=>{const o=c.find(i=>i.id===e);if(!o)return;const r=window.open("","_blank");if(!r){alert("Please allow popups to print the invoice");return}const l=`
            <html>
            <head>
