import{j as t,a as Y,r as h,C as J,z as L,A as w,E as M,H as A,G as N,I as E,O as K,P as _}from"./index-Drggu8kb.js";import{c as j,a as s,T as n,b as u}from"./Button-Ckuc6VIP.js";import{H as X,P as Z}from"./Header-ChlW0kea.js";import{A as I}from"./Avatar-BqSwCWai.js";import{G as c}from"./Grid-CeCav5Sc.js";import{S as z}from"./ShoppingCart-Djli__ll.js";import{S as D,E as tt,C as et}from"./ExpandMore-CBmZJWmM.js";import{C as k}from"./Card-BpgNUgbV.js";import{I as ot}from"./IconButton-Dn7Ej2Im.js";import{C as H}from"./CardContent-DGiMD-A7.js";import{C as st}from"./CheckCircle-BdEcosG9.js";import{C as rt,I as nt,H as it}from"./Inventory2-flqXnPMU.js";import{L as at}from"./LocalShipping-lqd43i8G.js";import"./useThemeProps-B2JTY9_F.js";import"./isMuiElement-9v0YadKW.js";const lt=j([t.jsx("path",{d:"M17 11c.34 0 .67.04 1 .09V6.27L10.5 3 3 6.27v4.91c0 4.54 3.2 8.79 7.5 9.82.55-.13 1.08-.32 1.6-.55-.69-.98-1.1-2.17-1.1-3.45 0-3.31 2.69-6 6-6"},"0"),t.jsx("path",{d:"M17 13c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4m0 1.38c.62 0 1.12.51 1.12 1.12s-.51 1.12-1.12 1.12-1.12-.51-1.12-1.12.5-1.12 1.12-1.12m0 5.37c-.93 0-1.74-.46-2.24-1.17.05-.72 1.51-1.08 2.24-1.08s2.19.36 2.24 1.08c-.5.71-1.31 1.17-2.24 1.17"},"1")]),dt=j([t.jsx("path",{d:"m12 2-5.5 9h11z"},"0"),t.jsx("circle",{cx:"17.5",cy:"17.5",r:"4.5"},"1"),t.jsx("path",{d:"M3 13.5h8v8H3z"},"2")]),ct=j(t.jsx("path",{d:"M20 2H4c-1 0-2 .9-2 2v3.01c0 .72.43 1.34 1 1.69V20c0 1.1 1.1 2 2 2h14c.9 0 2-.9 2-2V8.7c.57-.35 1-.97 1-1.69V4c0-1.1-1-2-2-2m-5 12H9v-2h6zm5-7H4V4l16-.02z"})),pt=j(t.jsx("path",{d:"m16 6 2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z"}));function Tt(){const a=Y(),[d,p]=h.useState([]),[g,y]=h.useState(!0),[O,P]=h.useState(0),[q,$]=h.useState(0),[v,V]=h.useState(null),C=(e,o)=>{try{const r=K(w,"orders",e);_(r,{status:o}),(async()=>{try{const i=L(w,"orders"),m=M(i,A("timestamp","desc"),N("status","==","pending")),b=(await E(m)).docs.map(f=>({id:f.id,...f.data()}));p(b);const x=b.length,S=b.reduce((f,Q)=>f+(Number(Q.total)||0),0);$(x),P(Number(S.toFixed(2)))}catch(i){console.error("Error refreshing data:",i)}})()}catch(r){console.error("Error updating order status:",r),alert("Failed to update order status")}},U=e=>{if(!e)return"Just now";const o=e.toDate(),l=new Date().getTime()-o.getTime(),i=Math.floor(l/(1e3*60*60*24));return i===0?`Today, ${o.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}`:i===1?`Yesterday, ${o.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}`:o.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})},B=e=>{V(v===e?null:e)},G=e=>{const o=d.find(i=>i.id===e);if(!o)return;const r=window.open("","_blank");if(!r){alert("Please allow popups to print the invoice");return}const l=`
            <html>
            <head>
