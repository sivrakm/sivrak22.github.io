import{a as q,u as B,r as c,j as e,C as U,b as H,d as u,q as M,o as Y,g as Q,k as J,e as D,f as K,h as V}from"./index-CA5h76Mg.js";import{B as r,T as i,a as l}from"./Button-C82hmiKU.js";import{I as f}from"./IconButton-C9bQE-uE.js";import{A as X}from"./ArrowBack-Bl7ME1Qm.js";import{S as _}from"./Search-wrb_ZOzP.js";import{S as x}from"./Stack-BfHIBaWj.js";import{C as G}from"./Card-_cQOhzWD.js";import{A as Z}from"./Avatar-d0z9RSuQ.js";import{E as k}from"./ExpandMore-DUcxV7cN.js";import{C as ee}from"./Collapse-DI0bXZpx.js";import{S as te}from"./ShoppingCart-C7DrNxOQ.js";import{D as oe}from"./Dialog-CaToyc2A.js";import{D as re,a as se,b as ie}from"./DialogTitle-tbiwfQYs.js";import{D as ae}from"./DialogContentText-cSvnLPQp.js";import{C as ne}from"./CheckCircle-fAEqnSjH.js";import{C as le,I as de,H as ce}from"./Inventory2-DQ4yva9-.js";import{L as pe}from"./LocalShipping-DUl9-OaP.js";import"./useThemeProps-CgAddm1V.js";import"./Modal-DkuF7EPz.js";const m=J`
    from {
        opacity: 0;
...
`;function We(){const T=q(),y=B(t=>t.user),[v,$]=c.useState([]),[z,j]=c.useState(!0),[n,I]=c.useState("All"),[h,W]=c.useState(null),[A,p]=c.useState(!1),[C,S]=c.useState(null),O=["All","Processing","Delivered","Cancelled"],g=async()=>{if(!y){j(!1);return}try{const t=H(u,"orders"),o=M(t,Y("timestamp","desc")),d=(await Q(o)).docs.map(a=>({id:a.id,...a.data()}));$(d)}catch(t){console.error("Error fetching orders:",t)}finally{j(!1)}};c.useEffect(()=>{g()},[y]);const w=v.filter(t=>n==="All"?!0:(t.status==="pending"?"Processing":t.status).toLowerCase()===n.toLowerCase()),L=t=>{switch(t.toLowerCase()){case"pending":case"processing":return{label:"Processing",icon:e.jsx(ce,{fontSize:"small"}),color:"warning.main",bgcolor:"rgba(237, 108, 2, 0.1)",borderColor:"rgba(237, 108, 2, 0.2)"};case"shipped":return{label:"Shipped",icon:e.jsx(pe,{fontSize:"small"}),color:"info.main",bgcolor:"rgba(2, 136, 209, 0.1)",borderColor:"rgba(2, 136, 209, 0.2)"};case"delivered":return{label:"Delivered",icon:e.jsx(de,{fontSize:"small"}),color:"success.main",bgcolor:"rgba(46, 125, 50, 0.1)",borderColor:"rgba(46, 125, 50, 0.2)"};case"cancelled":return{label:"Cancelled",icon:e.jsx(le,{fontSize:"small"}),color:"error.main",bgcolor:"rgba(211, 47, 47, 0.1)",borderColor:"rgba(211, 47, 47, 0.2)"};default:return{label:"Completed",icon:e.jsx(ne,{fontSize:"small"}),color:"text.secondary",bgcolor:"action.hover",borderColor:"divider"}}},b=(t,o)=>{try{const s=D(u,"orders",t);K(s,{status:o}),g()}catch(s){console.error("Error updating order status:",s),alert("Failed to update order status = "+t)}},P=async()=>{if(C)try{const t=D(u,"orders",C);await V(t),p(!1),S(null),alert("Order deleted successfully"),g()}catch(t){console.error("Error deleting order:",t),alert("Failed to delete order")}},E=t=>{S(t),p(!0)},F=t=>{if(!t)return"Just now";const o=t.toDate(),d=new Date().getTime()-o.getTime(),a=Math.floor(d/(1e3*60*60*24));return a===0?`Today, ${o.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}`:a===1?`Yesterday, ${o.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}`:o.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})},N=t=>{W(h===t?null:t)},R=t=>{const o=v.find(a=>a.id===t);if(!o)return;const s=window.open("","_blank");if(!s){alert("Please allow popups to print the invoice");return}const d=`
            <html>
            <head>
