import{f as p,j as d}from"./index-Dg6OSMVy.js";const r=p(d.jsx("path",{d:"M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"})),m=t=>{if(!t)return;const i=window.open("","_blank");if(!i){alert("Please allow popups to print the invoice");return}const n="Sri Perumal Depot",o=`
        <html>
        <head>
